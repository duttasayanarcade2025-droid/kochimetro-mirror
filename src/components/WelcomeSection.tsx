      ...
      <div className="container-custom">
        ...
        <div className="text-wrap-content mb-16">
          <AnimatedSection animation="fade-in-left">
            <img
              src={metroInterior}
              alt="Modern Kochi Metro station interior with spacious platforms and bright lighting"
              className="shape-float-left shape-organic w-full max-w-[45%] h-auto object-cover shadow-elegant hover-lift transition-all duration-500 rounded-2xl"
              loading="lazy"
              width="600"
              height="400"
            />
            ...
            <div className="space-y-4 mb-8">
              <AnimatedSection animation="fade-in-up" delay={400}>
                <div className="flex items-center space-x-3 group">
                  <div className="w-3 h-3 bg-metro-teal rounded-full animate-pulse-glow" aria-hidden="true"></div>
              ...
              <AnimatedSection animation="fade-in-up" delay={500}>
                <div className="flex items-center space-x-3 group">
                  <div className="w-3 h-3 bg-metro-teal rounded-full animate-pulse-glow" style={{ animationDelay: '0.5s' }} aria-hidden="true"></div>
              ...
              <AnimatedSection animation="fade-in-up" delay={600}>
                <div className="flex items-center space-x-3 group">
                  <div className="w-3 h-3 bg-metro-teal rounded-full animate-pulse-glow" style={{ animationDelay: '1s' }} aria-hidden="true"></div>
