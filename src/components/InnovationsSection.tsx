...
const InnovationsSection = () => {
  ...
  return (
    <section className="section-padding bg-white" aria-labelledby="innovations-heading">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  return (
                    <div key={innovation.title} className="text-center group cursor-pointer">
                      <div className="w-20 h-20 bg-metro-teal/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-metro-teal group-hover:scale-110 transition-all duration-300">
                        <IconComponent className="w-10 h-10 text-metro-teal group-hover:text-white transition-colors" aria-hidden="true" />
                      </div>
          ...
          {/* Content with Shape Outside */}
          <div className="order-1 lg:order-2 text-wrap-content">
            <AnimatedSection animation="fade-in-left">
              <img
                src={metroInterior}
                alt="Kochi Metro sustainable and innovative station design"
                className="shape-float-left shape-circle w-64 h-64 object-cover shadow-elegant rounded-full mb-4 hover-lift"
                loading="lazy"
                width="256"
                height="256"
              />
              <h2 id="innovations-heading" className="text-4xl lg:text-5xl font-heading font-bold text-gray-900 mb-6">
                How We Stand Apart
              </h2>
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-metro-teal rounded-full mt-2 flex-shrink-0" aria-hidden="true"></div>
