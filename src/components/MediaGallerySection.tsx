...
const MediaGallerySection = () => {
  ...
  return <section className="section-padding bg-white" aria-labelledby="media-gallery-heading">
      <div className="container-custom">
        {/* Creative Text Wrap Layout */}
        <div className="text-wrap-content mb-12">
          <AnimatedSection animation="fade-in-right">
            <div className="relative group cursor-pointer shape-float-right shape-ellipse w-full max-w-md h-96 overflow-hidden rounded-2xl shadow-elegant">
              <img 
                src={metroTrain} 
                alt="Kochi Metro train showcasing advanced technology and modern design" 
              ...
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors flex items-center justify-center">
                <Button size="lg" className="bg-white/20 hover:bg-white/30 text-white border-2 border-white/50 rounded-full w-16 h-16 p-0" aria-label="Play video">
          ...
          <AnimatedSection animation="fade-in-left">
            <h2 id="media-gallery-heading" className="text-4xl lg:text-5xl font-heading font-bold text-gray-900 mb-6">
              Media & Gallery
            </h2>
                  ...
                  <CardContent className="p-0 relative">
                    <div className="relative overflow-hidden rounded-lg">
                      ...
                      <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors flex items-center justify-center">
                        {item.type === 'video' ? <Play className="w-6 h-6 text-white" fill="currentColor" aria-label="Video" /> : <ImageIcon className="w-6 h-6 text-white" aria-label="Image" />}
                      </div>
                    </div>
            ...
            <Button className="bg-metro-teal hover:bg-metro-teal/90 text-white magnetic-btn">
              View All Media
            </Button>
          </AnimatedSection>
        </div>
